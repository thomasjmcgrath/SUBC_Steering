...
def update(frame, data_U, data_D, data_L, data_R):
    ...
    wma_window_size = 5  # Adjust the window size as needed
    filtered_data_U = weighted_moving_average(data_U, wma_window_size)
    filtered_data_D = weighted_moving_average(data_D, wma_window_size)
    filtered_data_L = weighted_moving_average(data_L, wma_window_size)
    filtered_data_R = weighted_moving_average(data_R, wma_window_size)
